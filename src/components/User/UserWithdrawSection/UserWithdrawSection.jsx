...
import "./UserWithdrawSection.css";

function UserWithdrawSection() {
  ...
  const fetchHistory = async () => {
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_BACKEND_URL}/api/withdrawals/my-withdrawals`,
        {
          headers: {
      ...
      if (response.ok) {
        ...
        setError(data.message || "Failed to fetch withdrawal history.");
      }
    } catch (err) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(data.message || "Failed to create withdrawal request.");
      }
    } catch (err) {
    ...
    <div className="userdepositsection">
      ...
      <div className="deposit-history-section">
        ...
        {isLoading ? (
          ...
          <div className="no-history">No withdrawal history found.</div>
        ) : (
